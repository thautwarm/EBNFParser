...
statement = AstParser([Ref('flowControl')],[Ref('declaration')],[Ref('flowControlSign'),Ref('Identifier')],[Ref('expression')],[SeqParser([Ref('Insertable')]),Ref('statement'),SeqParser([Ref('Insertable')])], name = 'statement')
...
While = AstParser([LiteralParser('while', name = '\'while\''),LiteralParser.Eliteral('(', name = '\'(\''),Ref('expression'),LiteralParser.Eliteral(')', name = '\')\''),Ref('body')], name = 'While')
declaration = AstParser([Ref('structDeclaration')],[Ref('variableDeclaration')], name = 'declaration')
structDeclaration = AstParser([LiteralParser('struct', name = '\'struct\''),Ref('Identifier'),LiteralParser.Eliteral('{', name = '\'{\''),SeqParser([SeqParser([Ref('Insertable')]),Ref('variableDeclarationEntry'),SeqParser([Ref('Insertable')])]),LiteralParser.Eliteral('}', name = '\'}\'')], name = 'structDeclaration')
...
Trailer = AstParser([LiteralParser.Eliteral('(', name = '\'(\''),Ref('expressionList'),LiteralParser.Eliteral(')', name = '\')\''),SeqParser([Ref('LambdaDef')], atmost = 1)],[LiteralParser.Eliteral('.', name = '\'.\''),Ref('Identifier')], name = 'Trailer')
