...
structDeclaration = AstParser([LiteralParser('struct', name='\'struct\''),Ref('Identifier'),LiteralParser('{', name='\'{\''),SeqParser([SeqParser([Ref('I')]),Ref('variableDeclarationEntry'),SeqParser([LiteralParser(',', name='\',\'')], atmost = 1),SeqParser([Ref('I')])]),LiteralParser('}', name='\'}\'')], name = 'structDeclaration', toIgnore = [{'I'}, set()])
...
variableDeclarationEntryList = AstParser([SeqParser([Ref('I')]),Ref('variableDeclarationEntry'),SeqParser([SeqParser([Ref('I')]),LiteralParser(',', name='\',\''),SeqParser([Ref('I')]),Ref('variableDeclarationEntry')]),SeqParser([Ref('I')])], name = 'variableDeclarationEntryList', toIgnore = [{'I'}, set()])
variableDeclaration = AstParser([DependentAstParser([LiteralParser('let', name='\'let\'')],[LiteralParser('var', name='\'var\'')]),Ref('variableDeclarationEntry'),SeqParser([LiteralParser('=', name='\'=\''),SeqParser([Ref('I')]),Ref('expression')], atmost = 1)], name = 'variableDeclaration', toIgnore = [{'I'}, set()])
...
expressionList = AstParser([SeqParser([Ref('I')]),Ref('expression'),SeqParser([SeqParser([Ref('I')]),LiteralParser(',', name='\',\''),SeqParser([Ref('I')]),Ref('expression')]),SeqParser([Ref('I')])], name = 'expressionList', toIgnore = [{'I'}, set()])
Trailer = AstParser([Ref('Call')],[Ref('Access')], name = 'Trailer')
Call = AstParser([LiteralParser('(', name='\'(\''),SeqParser([Ref('expressionList')], atmost = 1),LiteralParser(')', name='\')\''),SeqParser([Ref('LambdaDef')], atmost = 1)], name = 'Call', toIgnore = [{'I'}, set()])
Access = AstParser([SeqParser([Ref('I')]),LiteralParser('.', name='\'.\''),Ref('Identifier')], name = 'Access', toIgnore = [{'I'}, set()])
...
statements = AstParser([SeqParser([SeqParser([Ref('I')]),SeqParser([Ref('statement')]),SeqParser([Ref('I')])])], name = 'statements', toIgnore = [{'I'}, set()])
